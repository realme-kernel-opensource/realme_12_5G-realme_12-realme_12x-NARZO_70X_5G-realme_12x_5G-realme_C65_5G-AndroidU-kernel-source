...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	jdi_dcs_write_seq_static(ctx, 0xCA, 0x02);
...
#define VAC (1604)
#define HAC (720)
#define VFP_45hz (3482)
#define VFP_48hz (3160)
#define VFP_50hz (2970)
#define VFP_60hz (2200)
#define VFP_90hz (920)
#define VFP_120hz (280)
#define PLL_CLOCK (640)
#define DATA_RATE (1280)
