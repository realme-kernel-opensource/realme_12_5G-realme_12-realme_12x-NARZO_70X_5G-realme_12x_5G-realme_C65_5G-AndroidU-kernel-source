...
static void jdi_panel_init(struct jdi *ctx)
{
        ...
        jdi_dcs_write_seq_static(ctx, 0x08, 0x00);
        ...
        jdi_dcs_write_seq_static(ctx, 0x06, 0x43);
        jdi_dcs_write_seq_static(ctx, 0x0A, 0x5B);
        jdi_dcs_write_seq_static(ctx, 0x0C, 0x00);
        jdi_dcs_write_seq_static(ctx, 0x0D, 0x20);
        jdi_dcs_write_seq_static(ctx, 0x0E, 0x4D);
        jdi_dcs_write_seq_static(ctx, 0x39, 0x05);
        jdi_dcs_write_seq_static(ctx, 0x3A, 0x20);
        jdi_dcs_write_seq_static(ctx, 0x3B, 0x4D);
        jdi_dcs_write_seq_static(ctx, 0x3C, 0x82);
        jdi_dcs_write_seq_static(ctx, 0xF0, 0x03);
        jdi_dcs_write_seq_static(ctx, 0xF1, 0xC8);
        jdi_dcs_write_seq_static(ctx, 0x29, 0x48);
        jdi_dcs_write_seq_static(ctx, 0x2A, 0x48);
        ...
        jdi_dcs_write_seq_static(ctx, 0x03, 0x00);
        jdi_dcs_write_seq_static(ctx, 0x04, 0x92);
        ...
        jdi_dcs_write_seq_static(ctx, 0xFF, 0x98, 0x83, 0x08);
        jdi_dcs_write_seq_static(ctx, 0xE0, 0x00, 0x24, 0x33, 0x5B, 0x85, 0x50, 0xBD, 0xEF, 0x17, 0x47, 0x95, 0x6E, 0xAE, 0xE2, 0x10, 0xAA, 0x3D, \
        0x6C, 0xA2, 0xC5, 0xFE, 0xEF, 0x12, 0x3F, 0x75, 0x3F, 0xA1, 0xD8, 0xEC);
        jdi_dcs_write_seq_static(ctx, 0xE1, 0x00, 0x24, 0x33, 0x5B, 0x85, 0x50, 0xBD, 0xEF, 0x17, 0x47, 0x95, 0x6E, 0xAE, 0xE2, 0x10, 0xAA, 0x3D, \
        0x6C, 0xA2, 0xC5, 0xFE, 0xEF, 0x12, 0x3F, 0x75, 0x3F, 0xA1, 0xD8, 0xEC);
        ...
        jdi_dcs_write_seq_static(ctx, 0x9A, 0x48);
        jdi_dcs_write_seq_static(ctx, 0x9B, 0x88);
        jdi_dcs_write_seq_static(ctx, 0x9C, 0x06);
        jdi_dcs_write_seq_static(ctx, 0x9D, 0x06);
        ...
        jdi_dcs_write_seq_static(ctx, 0x68, 0x05, 0x00);
        jdi_dcs_write_seq_static(ctx, 0x11);
        usleep_range(105000, 105100);
        jdi_dcs_write_seq_static(ctx, 0xFF, 0x98, 0x83, 0x0E);
        jdi_dcs_write_seq_static(ctx, 0x14, 0x02);
        jdi_dcs_write_seq_static(ctx, 0xFF, 0x98, 0x83, 0x00);
...
#define VAC (1604)
#define HAC (720)
#define VFP_45hz (3780)
#define VFP_48hz (3440)
#define VFP_50hz (3220)
#define VFP_60hz (2430)
#define VFP_90hz (1070)
#define VFP_120hz (333)
/*#define DYN_PLL_CLK (514)
#define DYN_DATA_RATE (1028)
#define HFP_DYN (191)*/
#define PLL_CLOCK (650)
#define DATA_RATE (1300)
